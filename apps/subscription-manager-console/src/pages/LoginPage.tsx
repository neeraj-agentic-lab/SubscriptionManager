    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 bg-gray-50">
        <div className="max-w-lg w-full">
          ...
          {/* Demo Credentials */}
          <div className="mt-10 p-5 bg-white rounded-lg border border-gray-200 shadow-sm">
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded">
                <span className="font-medium text-gray-700">Tenant Admin:</span>
                <span className="font-mono">tenant@demo.com / tenant123</span>
              </div>
            </div>
          </div>
